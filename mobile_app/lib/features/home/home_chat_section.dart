...
extension _ChatSection on _HomePageState {
  ...
  Widget buildMessengerPage(TaskStore store, {required bool compact}) {
    ...
    return MessengerPage(
      ...
      activeCallState: _activeCallState,
      onOpenActiveCall: _openActiveCallScreen,
      onAcceptActiveCall: _acceptActiveCallFromBanner,
      onEndActiveCall: _endActiveCallFromBanner,
